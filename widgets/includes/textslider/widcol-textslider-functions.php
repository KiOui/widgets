<?php
/**
 * Functions for Widgets Text Sliders
 *
 * @package widgets
 */
...
if ( ! function_exists( 'widcol_text_sliders_string_to_array_ints' ) ) {
	/**
	 ...
	 * @return int[]
	 */
	function widcol_text_sliders_string_to_array_ints( string $input ): array {
