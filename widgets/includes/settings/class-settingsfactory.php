...
include_once WIDCOL_ABSPATH . 'includes/settings/class-settings.php';
include_once WIDCOL_ABSPATH . 'includes/settings/class-settingspage.php';
include_once WIDCOL_ABSPATH . 'includes/settings/class-settingsgroup.php';
include_once WIDCOL_ABSPATH . 'includes/settings/class-settingssection.php';
include_once WIDCOL_ABSPATH . 'includes/settings/class-settingsconfigurationexception.php';
